...
def venom():
    ...
    a.append(P('M 500 238 '
               'C 400 202, 298 228, 244 302 '
               'C 214 356, 214 424, 240 472 '
               'C 262 508, 288 530, 312 538 '
               'L 322 556 '
               'C 336 528, 346 502, 352 478 '
               'C 372 500, 412 540, 452 586 '
               'C 478 474, 476 344, 500 238 Z', WHITE, 13))
    a.append(P('M 524 238 '
               'C 624 202, 726 228, 780 302 '
               'C 810 356, 810 424, 784 472 '
               'C 762 508, 736 530, 712 538 '
               'L 702 556 '
               'C 688 528, 678 502, 672 478 '
               'C 652 500, 612 540, 572 586 '
               'C 546 474, 548 344, 524 238 Z', WHITE, 13))
...
def venom_overlay():
    # tongue drooping right, tip rolling back up in a curl
    return [
        P('M 415 785 '
          'C 392 880, 420 975, 500 1015 '
          'C 570 1042, 648 1022, 662 962 '
          'C 668 930, 650 905, 622 900 '
          'C 606 898, 592 908, 588 926 '
          'C 576 878, 550 845, 510 828 '
          'C 482 814, 448 800, 415 785 Z', '#d3557a', 12),
        P('M 466 856 C 512 918, 556 962, 606 958', 'none', 9),
    ]
