...
| 6 | Show-Inventory browser: card-image grid, Cardmarket £ + USD prices, set + type/rarity/colour/mana/value/full-art filters, name search, any-card mode over all ~107k printings, clipboard/CSV exports | ✅ |
